...
void sortAndDisplayMenu(vector<Product>& products) {
    ...
    cout << "nChoose a sorting criterion:n";
    cout << "1. Price (Bubble Sort)n";
    cout << "2. Rating (Selection Sort)n";
    cout << "3. Name (Quick Sort)n";
    cout << "4. Stock Quantity (Merge Sort)n";
    cout << "5. Discount Percentage (Heap Sort)n";
